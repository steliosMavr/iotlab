...
<form class="myForm1">
  ...
  <div class="col-10">
    <input class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" type="text" name="name" value="{{$project->name}}" maxlength="21" minlength="0"> 
    @if ($errors->has('name'))
  ...
  <div class="col-10">
       <textarea class="form-control {{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" rows="3" maxlength="150" minlength="0">{{$project->description}}</textarea>
...
<div class="custom-file">
  ...
  <label class="custom-file-label" for="inputGroupFile01" id="cover_image_label">{{$project->cover_image}}</label>
...
<div class="form-group">
    <textarea class="form-control" name="about" id="article-ckeditor">{{$project->about}}</textarea>
  </div>
                     

                      
     <input type="hidden" name="project_id" value="{{$project->id}}" id="pr_id">
...
@csrf
  ...
  <div class="col-10">
    <input class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" type="text" name="code_title" value="{{$project->code_title}}"  maxlength="21" minlength="0">
    @if ($errors->has('name'))
    <small  class="form-text text-muted" style="text-align:left;"><p class="p-0 m-0" style="color:red;">{{ $errors->first('name') }}</p></small>
  ...
  <label for="example-text-input" class="col-2 col-form-label">Περιγραφή</label>
  <div class="col-10">
       <textarea class="form-control {{ $errors->has('description') ? ' is-invalid' : '' }}" name="code_description" rows="3">{{$project->code_description}}</textarea>
       @if ($errors->has('description'))
    <small  class="form-text text-muted" style="text-align:left;color:red;"><p class="p-0 m-0" style="color:red;">{{ $errors->first('description') }}</p></small>
          @endif
       <small class="form-text text-muted" style="text-align:left;">Πληκτρολογήστε με σύντομο τρόπο τη λειτουργία του</small>
