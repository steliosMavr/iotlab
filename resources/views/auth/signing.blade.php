            ...
            <div class="col-md-7 text-center ">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                           ...
                           <form class="text-center mt-5" id="loginForm" method="POST" action="{{ route('login') }}">
                           @csrf
...
<div class="form-group row">                    
    <div class="col-md-12">
     ...
     <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="password" type="password" placeholder="Κωδικός" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
...
<div class="d-flex justify-content-around">
    ...
    <div>
        <!-- Forgot password -->
        <a href="{{ route('password.request') }}">Ξεχάσατε τον κωδικό σας;</a>
    </div>
</div>
