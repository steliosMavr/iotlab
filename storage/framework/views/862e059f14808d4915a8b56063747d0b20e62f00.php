...
<form class="myForm" id="basic_form">
  ...
  <div class="col-10">
    <input class="form-control <?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" type="text" name="name" maxlength="21" minlength="0">
  ...
  <div class="col-10">
       <textarea class="form-control <?php echo e($errors->has('description') ? ' is-invalid' : ''); ?>" name="description" rows="3" maxlength="150" minlength="0"></textarea>
...
<?php echo csrf_field(); ?>
  ...
  <div class="col-10">
    <input class="form-control <?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" type="text" name="code_title">
    <?php if($errors->has('name')): ?>
    <small  class="form-text text-muted" style="text-align:left;"><p class="p-0 m-0" style="color:red;"><?php echo e($errors->first('name')); ?></p></small>
  ...
  <label for="example-text-input" class="col-2 col-form-label">Περιγραφή</label>
  <div class="col-10">
       <textarea class="form-control <?php echo e($errors->has('description') ? ' is-invalid' : ''); ?>" name="code_description" rows="1"></textarea>
       <?php if($errors->has('description')): ?>
    <small  class="form-text text-muted" style="text-align:left;color:red;"><p class="p-0 m-0" style="color:red;"><?php echo e($errors->first('description')); ?></p></small>
          <?php endif; ?>
       <small class="form-text text-muted" style="text-align:left;">Πληκτρολογήστε με σύντομο τρόπο τη λειτουργία του</small>
...
<?php echo $__env->make('layouts.project_header', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>